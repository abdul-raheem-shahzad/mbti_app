...
st.header('MBTI Personality Prediction and Risk of Pain')
st.write('This app predicts weather which MBTI personality type you are\n Following are the personality types:')
#show picture
st.image(["personality.jpg"])
